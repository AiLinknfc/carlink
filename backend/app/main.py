...
from app.routers import admin, auth, certificates, diagnostics, documents, found_requests, gallery, maintenance, nfc, ocr, parts, service_logs, upload, vehicles, workshops
