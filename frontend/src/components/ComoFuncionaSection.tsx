        ...
        <div data-r="nfcScenes" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr auto 1fr', gap: 16, alignItems: 'center', maxWidth: 930, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '8px 14px', borderRadius: 999, ...stepPill(0) }}>
                <span style={{ width: 20, height: 20, flex: '0 0 auto', borderRadius: 6, background: 'rgba(245,197,24,0.14)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 700, color: isDark ? '#f5f3ec' : '#111' }}>01</span>
                <span style={{ fontSize: 12.5, fontWeight: 500, color: isDark ? '#f5f3ec' : '#111' }}>Ingresa tu placa</span>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '8px 14px', borderRadius: 999, ...stepPill(1) }}>
                <span style={{ width: 20, height: 20, flex: '0 0 auto', borderRadius: 6, background: 'rgba(245,197,24,0.14)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 700, color: isDark ? '#f5f3ec' : '#111' }}>02</span>
                <span style={{ fontSize: 12.5, fontWeight: 500, color: isDark ? '#f5f3ec' : '#111' }}>Activa tus indicadores</span>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '8px 14px', borderRadius: 999, ...stepPill(2) }}>
                <span style={{ width: 20, height: 20, flex: '0 0 auto', borderRadius: 6, background: 'rgba(245,197,24,0.14)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 700, color: isDark ? '#f5f3ec' : '#111' }}>03</span>
                <span style={{ fontSize: 12.5, fontWeight: 500, color: isDark ? '#f5f3ec' : '#111' }}>Publica tu ficha</span>
              </div>
            </div>
