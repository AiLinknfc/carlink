...
export const metadata: Metadata = {
  ...
  description:
    'Llavero NFC/QR resistente al agua y caídas: escanéalo para ver el historial de mantenimiento de tu vehículo, o para que un taller registre un servicio. $49.900 COP, envío a toda Colombia.',
  openGraph: {
