...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es">
      <head>
        <link rel="icon" type="image/png" sizes="31x31" href="/favicon-dark-31.png" id="favicon" />
        <script dangerouslySetInnerHTML={{ __html: "try{if(localStorage.getItem('carlink_theme')==='light')document.getElementById('favicon').href='/favicon-light-31.png'}catch(e){}" }} />
